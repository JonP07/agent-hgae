...
SESSION="alfworld_ppo_grpo_3b_nothink"
ENGINE=vllm
SCRIPT="run_scripts/grpo_ppo_3b_nothink/qwen_ppo_3b_nothink.sh"
SCRIPT2="run_scripts/grpo_ppo_3b_nothink/qwen_grpo_3b_nothink.sh"
