...
SESSION="alfworld_ppo_grpo_1.5b_nothink"
ENGINE=vllm
SCRIPT="run_scripts/grpo_ppo_1.5b_nothink/qwen_ppo_1.5b_nothink.sh"
SCRIPT2="run_scripts/grpo_ppo_1.5b_nothink/qwen_grpo_1.5b_nothink.sh"
